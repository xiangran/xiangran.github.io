...
![image_1c3i6eotg16r35qm1ddjke219e6p.png-120.4kB][1]
...
关于其他东西，可以看下图
![image_1c3i6hh16sdi1nv1mmq19so1js416.png-122kB][2]


>#### TCP的状态机

![image_1c3i6jp9tcl6krtogir91isn1j.png-69.3kB][3]
![image_1c3i6kbhjlphbe34u71tgo16hd20.png-518.3kB][4]

为什么建链接要3次握手，断链接需要4次挥手？

* 对于建链接的3次握手，主要是要初始化Sequence Number 的初始值。通信的双方要互相通知对方自己的初始化的Sequence Number（缩写为ISN：Inital Sequence Number）——所以叫SYN，全称Synchronize Sequence Numbers。也就上图中的 x 和 y。这个号要作为以后的数据通信的序号，以保证应用层接收到的数据不会因为网络上的传输的问题而乱序（TCP会用这个序号来拼接数据）。
* 对于4次挥手，其实你仔细看是2次，因为TCP是全双工的，所以，发送方和接收方都需要Fin和Ack。只不过，有一方是被动的，所以看上去就成了所谓的4次挥手。如果两边同时断连接，那就会就进入到CLOSING状态，然后到达TIME_WAIT状态。下图是双方同时断连接的示意图（你同样可以对照着TCP状态机看）：
![image_1c3i6ls19160tq4c193f7jlgc32d.png-54.1kB][5]
<center>两端同时断连接</center>
另外，有几个事情需要注意一下：
...
![image_1c3i6vdpo13ip1lou43r1sg8uj62q.png-186.8kB][6]
...
![image_1c3i73n3q3i01ev5195udu2t8s37.png-24.9kB][7]
...
![image_1c3i74mvn12n67h41sde1err1ee43k.png-172kB][8]
...
![image_1c3i7grhhkudeska561qtn191t41.png-98.6kB][9]
...
![image_1c3i7l5r31n3mhsv1gr6cvm1jbm4e.png-124kB][10]
上图中，我们可以看到：
...
下面我们来看一下发送方的滑动窗口示意图：
![image_1c3i7mb9gkeg1smn7lduajiv4r.png-47.7kB][11]
...
![image_1c3i7o851e7m8kb1qb5dqk1vid58.png-30.7kB][12]
下面我们来看一个接受端控制发送端的图示：
![image_1c3i7opnhspn13mnigksv3e2p5l.png-90.2kB][13]
...
![image_1c3i80uk368n9441jsu1eit1eoj62.png-192.5kB][14]
...
![image_1c3i88rg81nfq7dr9bc194m1hlu6f.png-84kB][15]
...
我们可以看到如果没有FACK在，那么在丢包比较多的情况下，原来保守的算法会低估了需要使用的window的大小，而需要几个RTT的时间才会完成恢复，而FACK会比较激进地来干这事。 但是，FACK如果在一个网络包会被 reordering的网络里会有很大的问题。
  ...
  [1]: http://static.zybuluo.com/xiangran/4d2eh5i8cp91ljk368f739by/image_1c3i6eotg16r35qm1ddjke219e6p.png
  [2]: http://static.zybuluo.com/xiangran/u4tjxhjzwurrdwc1wx4gx1ut/image_1c3i6hh16sdi1nv1mmq19so1js416.png
  [3]: http://static.zybuluo.com/xiangran/68li1wq26qq9rvjfhknkrs5z/image_1c3i6jp9tcl6krtogir91isn1j.png
  [4]: http://static.zybuluo.com/xiangran/dw6wungpnatgvcdn902x1sie/image_1c3i6kbhjlphbe34u71tgo16hd20.png
  [5]: http://static.zybuluo.com/xiangran/s5i1lso2gr4f5lsphi847xzt/image_1c3i6ls19160tq4c193f7jlgc32d.png
  [6]: http://static.zybuluo.com/xiangran/mko6kj8jkcmouc16tho1q9k8/image_1c3i6vdpo13ip1lou43r1sg8uj62q.png
  [7]: http://static.zybuluo.com/xiangran/cgqwjoz5u8867bzir9mgxec6/image_1c3i73n3q3i01ev5195udu2t8s37.png
  [8]: http://static.zybuluo.com/xiangran/h447eii96cgefkh794cer9j4/image_1c3i74mvn12n67h41sde1err1ee43k.png
  [9]: http://static.zybuluo.com/xiangran/yac7nst8brlih89b4ur52h4x/image_1c3i7grhhkudeska561qtn191t41.png
  [10]: http://static.zybuluo.com/xiangran/75qqkym9h848f2sfdb1qjz7a/image_1c3i7l5r31n3mhsv1gr6cvm1jbm4e.png
  [11]: http://static.zybuluo.com/xiangran/zahgthnjwm90klrjsaa7uzc5/image_1c3i7mb9gkeg1smn7lduajiv4r.png
  [12]: http://static.zybuluo.com/xiangran/613ct575gqh3grwxmvlfauc0/image_1c3i7o851e7m8kb1qb5dqk1vid58.png
  [13]: http://static.zybuluo.com/xiangran/iasmo3wj9795ri10lbc5wu1o/image_1c3i7opnhspn13mnigksv3e2p5l.png
  [14]: http://static.zybuluo.com/xiangran/ywuwg9nzjw93zjwzil4470zl/image_1c3i80uk368n9441jsu1eit1eoj62.png
  [15]: http://static.zybuluo.com/xiangran/otff8ul1read65rd5ixxocb9/image_1c3i88rg81nfq7dr9bc194m1hlu6f.png